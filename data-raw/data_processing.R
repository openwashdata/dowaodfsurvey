...
data_in <- readr::read_csv("data-raw/dowa odf survey 2019.csv")
...
# Export Data ------------------------------------------------------------------
usethis::use_data(dowaodf, overwrite = TRUE)
fs::dir_create(here::here("inst", "extdata"))
readr::write_csv(dowaodf,
                 here::here("inst", "extdata", paste0("dowaodf", ".csv")))
openxlsx::write.xlsx(dowaodf,
                     here::here("inst", "extdata", paste0("dowaodf",
                                                          ".xlsx")))
